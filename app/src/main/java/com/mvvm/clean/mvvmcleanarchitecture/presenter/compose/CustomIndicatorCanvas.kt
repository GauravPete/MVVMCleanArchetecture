...
fun CustomIndicatorCanvas(
    ...
    val animatableIndicatorValue = remember { Animatable(initialValue = 0f) }
    LaunchedEffect(key1 = allowedIndicatorValue) {
        animatableIndicatorValue.animateTo(allowedIndicatorValue.toFloat())
    }
    val presentage = (animatableIndicatorValue.value / maxIndicatorValue) * 100f
    val sweepAngle by animateFloatAsState(
        targetValue = (2.4 * presentage).toFloat(),
